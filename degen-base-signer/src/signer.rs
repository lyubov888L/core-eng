                ...
                let msg = Message {
                    ...
                    sig: match out {
                        ...
                        MessageTypes::VoteOutActorRequest(msg) => msg
                            ...
                            .to_vec(),
                        MessageTypes::POXTxidResponse(msg) => msg
                            .sign(&network_private_key)
                            .expect("failed to sign POXTxidResponse")
                            .to_vec(),
...
fn verify_msg(
    ...
    match &m.msg {
        ...
        MessageTypes::POXTxidResponse(msg) => {
            if !msg.verify(&m.sig, coordinator_public_key) {
                warn!("Received a POXTxidResponse message with an invalid signature.");
                return false;
            }
        }
